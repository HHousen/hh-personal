...
A logical and detail-oriented **junior** at **Cornell University** studying **computer science**. Currently, researching **AI song generation** and an **ML/SWE intern** at **[Vocode](https://vocode.dev)**. Previously, an intern on the **Machine Learning** Team at **[Ada Support](https://www.ada.cx/)**.
